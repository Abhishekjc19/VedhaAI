              ...
              <div key={assignment.id} className="card p-6 hover:shadow-lg transition-shadow">
                <div className="mb-4 flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-gray-600">{assignment.topic}</p>
                  </div>
                  <span className={`inline-block rounded-full px-3 py-1 text-xs font-semibold ${getStatusBadgeColor(assignment.status)}`}>
                    {assignment.status}
                  </span>
                </div>
                ...
                <div className="mb-4 space-y-2 text-sm text-gray-600">
                  ...
                  <p>Questions: {assignment.numberOfQuestions} | Marks: {assignment.totalMarks}</p>
                </div>

                <div className="flex gap-2">
                  <button
                    onClick={() => router.push(`/assignment/${assignment.id}/generate`)}
